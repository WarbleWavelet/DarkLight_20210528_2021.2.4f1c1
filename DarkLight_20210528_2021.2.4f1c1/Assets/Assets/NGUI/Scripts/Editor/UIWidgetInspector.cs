...
public class UIWidgetInspector : UIRectEditor
{
	...
	static void UpdateChildrenDepth(UIWidget parent, int increment)
	{
		var childWidgets = parent.GetComponentsInChildren<UIWidget>(true);
		foreach (var widget in childWidgets.Where(widget => widget != parent))
		{
